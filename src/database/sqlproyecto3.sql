...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-02-2024 a las 20:19:25
...
INSERT INTO `actividades` (`id_actividad`, `tipo_actividad`, `dia`, `estado_actividad`, `lugar_actividad`, `fecha_actividad`) VALUES
(1, 2, 'martes', 'asignada', 4, '2024-01-31 14:29:49'),
(2, 1, 'jueves', 'asignada', 3, '2024-01-31 14:29:49');
...
(1, 'bodega 1', 5000, 202, -34),
(2, 'bodega 2', 4000, 20, 0),
(3, 'bodega 3', 5000, 12, -12);
...
INSERT INTO `movimientos` (`id_movimiento`, `tipo_movimiento`, `cantidad`, `fecha`, `usuario_adm`, `fk_residuo`, `fk_actividad`) VALUES
(1, 'entrada', 20, '2024-01-28', 1, 1, 1),
(2, 'entrada', 25, '2024-01-28', 1, 2, 2),
(3, 'entrada', 10, '2024-01-28', 2, 1, 1),
(4, 'salida', 5, '2024-01-28', 1, 2, NULL),
(5, 'entrada', 100, '2024-01-30', 1, 3, 2),
(7, 'entrada', 2, '2024-01-30', 2, 1, 1),
(9, 'salida', 2, '2024-01-30', 2, 3, NULL),
(10, 'entrada', 12, '2024-01-30', 1, 4, 2),
(11, 'entrada', 1, '2024-01-30', 2, 1, 1),
(12, 'entrada', 2, '2024-01-30', 1, 1, 2);
...
(41, 'Diego', 'Díaz', '321654989', 'diego.diaz@example.com', 'contraseña35', 'pasante', 'activo');
...
--
ALTER TABLE `residuos`
  MODIFY `id_residuo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
